...
abstract class RustLibApi extends BaseApi {
  ...
  Future<bool> crateApiNightdropCoreBurnReceiptsEnabled(
      {required NightdropCore that});
  ...
  Future<List<ChatMessage>> crateApiNightdropCoreSendBurnMedia(
      {required NightdropCore that,
      required String contactId,
  ...
  Future<List<ChatMessage>> crateApiNightdropCoreSendBurnMessage(
      {required NightdropCore that,
      required String contactId,
      required String text,
      required BigInt burnSecs});
  ...
  Future<void> crateApiNightdropCoreSetBurnReceipts(
      {required NightdropCore that, required bool enabled});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<bool> crateApiNightdropCoreBurnReceiptsEnabled(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiNightdropCoreBurnReceiptsEnabledConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiNightdropCoreBurnReceiptsEnabledConstMeta =>
      const TaskConstMeta(
        debugName: "NightdropCore_burn_receipts_enabled",
        argNames: ["that"],
      );
  ...
  TaskConstMeta get kCrateApiNightdropCoreCheckForUpdateConstMeta =>
      const TaskConstMeta(
        debugName: "NightdropCore_check_for_update",
        argNames: ["that", "currentVersion"],
      );
  ...
  Future<List<ChatMessage>> crateApiNightdropCoreSendBurnMedia(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiNightdropCoreSendBurnMediaConstMeta,
      argValues: [that, contactId, data, mime, kind, burnSecs],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiNightdropCoreSendBurnMediaConstMeta =>
      const TaskConstMeta(
        debugName: "NightdropCore_send_burn_media",
        argNames: ["that", "contactId", "data", "mime", "kind", "burnSecs"],
      );
  ...
  Future<List<ChatMessage>> crateApiNightdropCoreSendBurnMessage(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiNightdropCoreSendBurnMessageConstMeta,
      argValues: [that, contactId, text, burnSecs],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiNightdropCoreSendBurnMessageConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiNightdropCoreSetBurnReceipts(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiNightdropCoreSetBurnReceiptsConstMeta,
      argValues: [that, enabled],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiNightdropCoreSetBurnReceiptsConstMeta =>
      const TaskConstMeta(
        debugName: "NightdropCore_set_burn_receipts",
  ...
  TaskConstMeta get kCrateApiNightdropCoreSetCaptureReportingConstMeta =>
      const TaskConstMeta(
        debugName: "NightdropCore_set_capture_reporting",
  ...
  TaskConstMeta get kCrateApiCheckBridgeConstMeta => const TaskConstMeta(
        debugName: "check_bridge",
        argNames: ["line"],
      );
  ...
  TaskConstMeta get kCrateApiReadBridgesConstMeta => const TaskConstMeta(
        debugName: "read_bridges",
        argNames: ["dir"],
      );
  ...
  AppEvent dco_decode_app_event(dynamic raw) {
    ...
    return AppEvent(
      ...
      progress: dco_decode_opt_box_autoadd_transfer_progress(arr[2]),
    );
  }
  ...
  AppUpdate dco_decode_box_autoadd_app_update(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_app_update(raw);
  }
  ...
  ChatMessage dco_decode_chat_message(dynamic raw) {
    ...
    return ChatMessage(
      ...
      burnSecs: dco_decode_u_64(arr[13]),
      viewedAt: dco_decode_u_64(arr[14]),
    );
  }
  ...
  AppUpdate? dco_decode_opt_box_autoadd_app_update(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_app_update(raw);
  }
  ...
  AppUpdate sse_decode_app_update(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    final var_current = sse_decode_String(deserializer);
  ...
  AppUpdate sse_decode_box_autoadd_app_update(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_app_update(deserializer));
  }
  ...
  ChatMessage sse_decode_chat_message(SseDeserializer deserializer) {
    ...
    final var_burnSecs = sse_decode_u_64(deserializer);
    final var_viewedAt = sse_decode_u_64(deserializer);
    return ChatMessage(
        fromMe: var_fromMe,
        text: var_text,
        system: var_system,
  ...
  AppUpdate? sse_decode_opt_box_autoadd_app_update(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_app_update(deserializer));
    } else {
      return null;
    }
  }
  ...
  TransferProgress sse_decode_transfer_progress(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    final var_done = sse_decode_u_64(deserializer);
    final var_total = sse_decode_opt_box_autoadd_u_64(deserializer);
  ...
  void sse_encode_app_event(AppEvent self, SseSerializer serializer) {
    ...
    sse_encode_opt_box_autoadd_transfer_progress(self.progress, serializer);
  }
  ...
  void sse_encode_chat_message(ChatMessage self, SseSerializer serializer) {
    ...
    sse_encode_u_64(self.burnSecs, serializer);
    sse_encode_u_64(self.viewedAt, serializer);
  }
  ...
  void sse_encode_opt_box_autoadd_app_update(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_app_update(self, serializer);
    }
  }
...
class NightdropCoreImpl extends RustOpaque implements NightdropCore {
  ...
  Future<bool> burnReceiptsEnabled() =>
      RustLib.instance.api.crateApiNightdropCoreBurnReceiptsEnabled(
        that: this,
      );
  ...
  Future<List<ChatMessage>> sendBurnMedia(
          ...
          required String kind,
          required BigInt burnSecs}) =>
      RustLib.instance.api.crateApiNightdropCoreSendBurnMedia(
          that: this,
          contactId: contactId,
          data: data,
          mime: mime,
  ...
  /// applies here too.
  Future<List<ChatMessage>> sendBurnMessage(
          {required String contactId,
          required String text,
          required BigInt burnSecs}) =>
  ...
  Future<void> setBurnReceipts({required bool enabled}) => RustLib.instance.api
      .crateApiNightdropCoreSetBurnReceipts(that: this, enabled: enabled);
